    ...
    <li class="right-pane">
	    <div class="STEM_OVERFLOW">
            ...
            <div class="page-content">
				...
				<?php
					echo _ERROR($err);				
                    $th = 'topic,headline,source,CRT,date,time';
                    $predef = JSP_FETCH_IPREDEF($TABLE,'image,article,link,views,id',0);
                    $td = JSP_SSQL_PAGI($predef,$_REQUEST['BLN_PAGI_CHANGE']);				
					$td = JSP_TRANS_PREDEF($td,DRA_ENUMS_SWISS('TOPIC'),0);
